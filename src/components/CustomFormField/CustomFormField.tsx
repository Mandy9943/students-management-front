    ...
    case FormFieldType.INPUT:
      return (
        <div className="flex rounded-md border border-dark-500 bg-dark-400">
          ...
          <FormControl>
            <Input placeholder={props.placeholder} {...field} className="border border-gray-200" />
          </FormControl>
        </div>
      );
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className="w-full space-y-1">
          {props.fieldType !== FormFieldType.CHECKBOX && label && <FormLabel className="text-ring ">{label}</FormLabel>}
